function create(__helpers) {
  ...
  return function render(data, out) {
    ...
    out.w('</ul></div><button type="button" onclick="update()" id="update">Update</button><form method="post" action="/todo/update" id="updateform"><input type="hidden" name="updatetext" id="updatetext" value="naqan"></form><script id="jsbin-javascript">\n// List with handle\nSortable.create(listWithHandle, {\n  handle: \'.my-handle\',\n  animation: 150\n});\nSortable.create(listWithHandle2, {\n  handle: \'.my-handle\',\n  animation: 150\n});\nSortable.create(listWithHandle3, {\n  handle: \'.my-handle\',\n  animation: 150\n});\n\n</script></body></html>');
  };
}
